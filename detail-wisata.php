<?php 
    ...
    $ambilFotoGalWis = $conn->query("SELECT * FROM tbl_wisata JOIN tbl_galeri_wisata ON tbl_wisata.id_wisata = tbl_galeri_wisata.id_wisata ORDER BY tbl_wisata.id_wisata DESC LIMIT 9");
...
<head>
    ...
    <title>Wisata Ambon | Detail Wisata</title>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-9">
                    <div class="destination_info">
                        <h3>Deskripsi  <?=$pecahWisata["nama_wisata"]; ?></h3>
                        <p class="text-left">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br><Bbr>
                    <div class="destination_info">
                        <h4 class="mb-3">Info wisata</h4>
                        <p>
                            <span><strong>Alamat wisata : </strong><?=$pecahWisata["alamat_wisata"]; ?></span><br>

                            <span><strong>Kategori wisata: </strong>Wisata <?=$pecahWisata["kategori_wisata"]; ?></span><br>

                            <span><strong>Jam Operasional : </strong><?=$pecahWisata["jam_buka"]; ?></span><br>
                            ...
                            <span><strong>No Telepon : </strong><?=$pecahWisata["nomor_telepon"]; ?></span>
                        </p>
                    </div>
                    <hr class="mt-5 pb-3">
                    <div class="destination_info">
                            ...
                            <div class="row">
                                <div class="col-3 text-left">
                                    <a href="<?=$pecahWisata['instagram']; ?>" target="_blank">
                                        <img src="dist/img/sosmed/ig.png" alt="Instagram Logo" width="20%">
                                    </a>
                                </div>
                                <div class="col-3 text-center">
                                    <a href="<?=$pecahWisata['youtube']; ?>" target="_blank">
                                        <img src="dist/img/sosmed/yt.png" alt="YouTube Logo" width="20%">
                                    </a>
                                </div>
                            </div>
                        </p>
                    ...
                    <div class="section-top-border" style="border-top: none;">
                        <h3>Galeri Wisata <?=$pecahWisata["nama_wisata"]; ?></h3>
                        ...
                        <hr class="mt-5 pb-3">
                        <h3>Lokasi Wisata <?=$pecahWisata["nama_wisata"]; ?></h3><br><br>
                        <div class="map-area">                        
    ...
    <!-- destinasi area -->
    <?php require "components/destinasi-lain.php"; ?>
