...
<head>
    ...
    <title>Wisata Ambon | Pencarian</title>
...
<body>
    ...
    <!--================Blog Area =================-->
    <section class="blog_area section-padding" style="padding-top: 30px; padding-left: 70px;">
        <div class="container">
            <div class="row">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="media post_item">
                                    <img src="admin-dolano/dist/img/tour-img/<?=$pecahDataWis['foto_wisata']; ?>" alt="Foto wisata" width="40%" height="150px">
                                    <div class="media-body">
                                        ...
                                        <div class="days">
                                            ...
                                            <a href="<?=$pecahDataWis['url_lokasi']; ?>">Lokasi wisata</a>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
