...
<head>
    ...
    <title>Wisata Ambon | Wisata</title>
...
<body>
    ...
    <!-- bradcam_area  -->
      <div class="bradcam_area " style="background-image:  url('bg7.png'); height: 400px;" >
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        ...
                        <p>Nikmati Pengalaman Wisata Anda diberbagai Destinasi Wisata <br> Kota Ambon </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="more_place_btn text-center">
                                <a class="boxed-btn4" href="" id="btn-loadMorePlaces" style="background: #48D1CC">Tampilkan Semua</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="filter_result_wrap">
                        <h3>Cari wisata berdasarkan kategori</h3>
                        <div class="filter_bordered">
                            ...
                            <div class="reset_btn">
                                <button class="boxed-btn4" type="submit" id="btn-tampilkan" style="background: #48D1CC">Tampilkan</button>
                            </div>
                        </div>
    ...
    <!-- galeri wisata -->
    <?php require "components/galeri_wisata.php"; ?>
