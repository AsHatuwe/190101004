...
<head>
    ...
    <title>Wisata Ambon | Beranda</title>
...
<body>
    ...
    <div class="slider_area">
        <div class="slider_active owl-carousel">
            <div style="background-image:  url('b1.png'); height: 700px;" class="single_slider  d-flex align-items-center slider overlay" >
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div  class="slider_text text-center"> 
                                <h3>Pantai Liang</h3>
                                <p>Nikmati  Keindahan Pesisir Pantai Dengan Berbagai Wahana Laut</p>
            ...
            <div style="background-image:  url('b2.png'); height: 650px;" class="single_slider  d-flex align-items-center slider overlay" >
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div  class="slider_text text-center"> 
                                <h3>Air Terjun </h3><br>
                                <p>Nikmati Keindahan Air Terjun Dipegunungan Telagapange</p>
                                <a href="#destinasi-wisata" class="boxed-btn3">Telusuri Sekarang</a>
                            </div>
                        </div>
                    </div>
           ...
           <div style="background-image:  url('b3.png'); height: 650px;" class="single_slider  d-flex align-items-center slider overlay" >
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div  class="slider_text text-center"> 
                                <h3>Benteng </h3><br>
                                <p>Nikmati Wisata Bersejarah Perpaduan Dengan Budaya Maluku</p>
                                <a href="#destinasi-wisata" class="boxed-btn3">Telusuri Sekarang</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>Anda akan selalu dimanjakan dengan banyak tempat wisata baru yang sedang hits dan populer dikota Ambon, dengan pemandangan indah yang memanjakan mata juga berbagai fasilitas dan wahana yang patut anda coba.</p>
                    </div>
                </div>
            </div>
            <div class="row">
