<div class="popular_places_area" id="destinasi-wisata" style="background: #DCDCDC">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section_title text-center mb_70">
                    <h3>Destinasi wisata lainnya</h3>
                    <p>Berikut ini adalah daftar destinasi wisata dikota ambon yang harus anda coba, rasakan pengalamannya dan ceritakan pengalaman anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="more_place_btn text-center">
                    <a href="" class="boxed-btn4 text-white" id="btn-loadMorePlaces" style="background: #48D1CC">Tampilkan Semua</a>
                </div>
            </div>
        </div>
    </div>
