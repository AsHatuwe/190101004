    	...
    	<div class="row mb-2">
	        ...
	        <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Wisata pegunungan</li>
              </ol>
	        </div>
    	</div>
    </div><!-- /.container-fluid -->
          	...
          	<table class="table table-striped projects">
              	...
              	<tbody>
                    ...
                    ?>
                  	<tr>
                    	<td><?=$no; ?></td>
                      <td><?=$pecahDataPeg['nama_wisata']; ?></td>
                    	<td><?=$pecahDataPeg['kategori_wisata']; ?></td>
                    	<td><?=$pecahDataPeg['alamat_wisata']; ?></td>
	                    <td><a href="<?=$pecahDataPeg['url_lokasi']; ?>" target="_blank">Lihat Peta</a></td>
                      <td><?=$pecahDataPeg['nomor_telepon']; ?></td>
                      <td><?=$pecahDataPeg['jam_buka']; ?></td>
                      <td><?=number_format($pecahDataPeg['harga_tiket_dewasa']); ?></td>
                      <td><?=number_format($pecahDataPeg['harga_tiket_anak']); ?></td>
                      <td><img src="dist/img/tour-img/<?=$pecahDataPeg['foto_wisata']; ?>" class="img-thumbnail" width="200" alt="Foto wisata"></td>
                    	<td class="text-right">
                      	<a class="btn btn-info btn-sm" href="index.php?halaman=edit-wisata&id=<?=$pecahDataPeg['id_wisata']; ?>" style="background: #4682b4"><i class="fas fa-pencil-alt"></i> Edit
                        </a>
