  ...
  if(isset($_POST["submit"])) {
    ...
    if(!empty($namaLokasi)) {
      ...
      if( $namaEkstensi == "jpg" || 
        ...
        $conn->query("UPDATE tbl_wisata SET nama_wisata = '$namaWisata', alamat_wisata = '$alamatWisata', url_lokasi = '$urlLokasi', peta_area = '$petaArea', nomor_telepon = '$nomorTelepon', jam_buka = '$jamBuka', harga_tiket_dewasa = '$hargaTiketDewasa', harga_tiket_anak = '$hargaTiketAnak', id_kategori_wisata = '$idKategoriWisata', instagram = '$instagram', youtube = '$youtube', deskripsi_wisata = '$deskripsiWisata', foto_wisata = '$fotoWisata' WHERE id_wisata = '$idUrl'");
      ...
      $conn->query("UPDATE tbl_wisata SET nama_wisata = '$namaWisata', alamat_wisata = '$alamatWisata', url_lokasi = '$urlLokasi', peta_area = '$petaArea', nomor_telepon = '$nomorTelepon', jam_buka = '$jamBuka', harga_tiket_dewasa = '$hargaTiketDewasa', harga_tiket_anak = '$hargaTiketAnak', id_kategori_wisata = '$idKategoriWisata', instagram = '$instagram', youtube = '$youtube', deskripsi_wisata = '$deskripsiWisata' WHERE id_wisata = '$idUrl'");
    ...
    if($lokasiFileFoGal == [""]) {
      ...
      echo "<script>
              ...
              Swal.fire({
                  icon: 'success',
                  title: 'Data wisata berhasil diubah',
                  showConfirmButton: true
              }).then(() => {
        ...
        <div class="card card-primary">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama-wisata" name="nama_wisata" placeholder="Masukkan nama wisata" value="<?=$pecahDataWisata['nama_wisata']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="alamat-wisata" name="alamat_wisata" placeholder="Masukkan alamat wisata" value="<?=$pecahDataWisata['alamat_wisata']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="url-lokasi" name="url_lokasi" placeholder="Masukkan url lokasi wisata" value="<?=$pecahDataWisata['url_lokasi']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="peta-area" name="peta_area" placeholder="Masukkan source peta area" value="<?=$pecahDataWisata['peta_area']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="harga-tiket-dewasa" name="harga_tiket_dewasa" placeholder="Masukkan harga tiket dewasa" value="<?=$pecahDataWisata['harga_tiket_dewasa']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="harga-tiket-anak" name="harga_tiket_anak" placeholder="Masukkan harga tiket anak" value="<?=$pecahDataWisata['harga_tiket_anak']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="nomor-telepon" name="nomor_telepon" placeholder="Masukkan nomor telepon" value="<?=$pecahDataWisata['nomor_telepon']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="jam-buka" name="jam_buka" placeholder="Masukkan jam operasional" value="<?=$pecahDataWisata['jam_buka']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="youtube" name="youtube" placeholder="Masukkan link video youtube" value="<?=$pecahDataWisata['youtube']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="instagram" name="instagram" placeholder="Masukkan link instagram" value="<?=$pecahDataWisata['instagram']; ?>" required>
                </div>
              </div>
              <!-- /.col -->
            </div>
                ...
                <div class="form-group">
                  <label for="input-foto">Input foto</label>
                    <div class="input-group">
                      <input type="file"  id="input-foto" name="foto_wisata">
                    </div>
                </div>
                <!-- Foto lama -->
                <div class="form-group">
          ...
          <div class="card-footer">
            <div class="text-center">
              <button type="submit" class="btn btn-primary" name="submit" style="background: #4682b4">Update</button>
              <a href="index.php?halaman=wisata-<?=strtolower($pecahDataWisata['kategori_wisata']); ?>" class="btn btn-warning"  style="color: white;">Batal</a><br><br>
            </div>
          </div>
